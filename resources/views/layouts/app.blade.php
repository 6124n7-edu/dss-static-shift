    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 bg-gray-900 text-white flex-shrink-0 hidden md:block">
            ...
            <nav class="mt-6 px-4 space-y-2">
                <!-- Dashboard -->
                <a href="{{ route('dashboard') }}" class="group flex items-center px-4 py-3 text-sm font-medium rounded-md hover:bg-gray-800 transition {{ request()->routeIs('dashboard') ? 'bg-indigo-600' : '' }}">
                ...
                <!-- Criteria -->
                <a href="{{ route('criteria.index') }}" class="group flex items-center px-4 py-3 text-sm font-medium rounded-md hover:bg-gray-800 transition {{ request()->routeIs('criteria.*') ? 'bg-indigo-600' : '' }}">
                    <i class="fa-solid fa-layer-group w-6 text-center mr-2"></i> Data Kriteria
                </a>
                
                <!-- Alternatives -->
                <a href="{{ route('alternatives.index') }}" class="group flex items-center px-4 py-3 text-sm font-medium rounded-md hover:bg-gray-800 transition {{ request()->routeIs('alternatives.*') ? 'bg-indigo-600' : '' }}">
                ...
                <!-- Evaluation -->
                <a href="{{ route('evaluations.index') }}" class="group flex items-center px-4 py-3 text-sm font-medium rounded-md hover:bg-gray-800 transition {{ request()->routeIs('evaluations.*') ? 'bg-indigo-600' : '' }}">
                    <i class="fa-solid fa-pen-to-square w-6 text-center mr-2"></i> Penilaian
                </a>

                <!-- Calculation -->
                <a href="{{ route('aras.result') }}" class="group flex items-center px-4 py-3 text-sm font-medium rounded-md hover:bg-gray-800 transition {{ request()->routeIs('aras.*') ? 'bg-indigo-600' : '' }}">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            <header class="h-16 bg-white border-b flex items-center justify-between px-6">
                ...
                <div class="flex items-center">
                    <span class="text-sm text-gray-600 mr-2">Admin Developer</span>
